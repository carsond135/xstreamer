            ...
            <div class="panel-body">
                ...
                <form action="{{URL('admincp/grab-video')}}" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    <div class="form-group">
                        ...
                        <div class="col-md-10"><input type="text" name="url" class="form-control" value="" 
                                                      placeholder="Input url video to grab "></div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <textarea name="tags" class="form-control">
                                    <?php echo !empty($data['tag']) ? str_replace('  ', '', trim($data['tag'])) : '' ?>
                                </textarea>
                            </div>
                        </div>
                        <div class="form-group">
