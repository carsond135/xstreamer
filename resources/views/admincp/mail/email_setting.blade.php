       		...
       		<div class="panel panel-primary">
				...
				<form action="{{URL('admincp/email-setting')}}" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
						...
						<div class="form-group">
							<div class="col-md-4"><label class="lable-control">Admin Change Password</label></div>
							<div class="col-md-8">
						...
						<div class="form-group">
							<div class="col-md-4"><label class="lable-control">Member Forgot Password</label></div>
							<div class="col-md-8">
						...
						<div class="form-group">
							<div class="col-md-4"><label class="lable-control">Confirm Signup</label></div>
							<div class="col-md-8">
						...
						<div class="form-group">
							<div class="col-md-4"><label class="lable-control">Channel Subscription Welcome </label></div>
							<div class="col-md-8">
						...
						<div class="form-group">
							<div class="col-md-4"><label class="lable-control">Channel Register Email</label></div>
							<div class="col-md-8">
