...
@section('content')
<h4 class="alert_info">Welcome to Infomation FQA administrator </h4>
@if(session('msg'))<div class="alert alert-success"><span class="fa fa-check"></span><strong> {{session('msg')}}</strong></div>@endif
<article class="module width_full">
    <div class="add"><a href="{{URL('admincp/add-fqa')}}"><i class="fa fa-plus-circle"></i> Add FQA</a></div>
    <header><h3 class="tabs_involved">Video Comment</h3></header>
    <table class="tablesorter" cellspacing="0" cellpadding="0"> 
        ...
        <tbody>
            ...
            <tr> 
                ...
                <td align="center">
                    <a href="{{URL('admincp/edit-fqa/')}}/{{$result->id}}"><i style="font-size: 20px ; margin: 5px" class="fa fa-pencil-square-o"></i></a>
                    <a href="{{URL('admincp/delete-fqa/')}}/{{$result->id}}" onclick="return confirm('Are you sure you want to remove this ?')"><i style="font-size: 20px ; margin: 5px" class="fa fa-trash-o"></i></a>
                </td>
