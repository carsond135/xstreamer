		...
		<div class="row ">
				<div class="modal-dialog col-md-12" style="width:100% !important">
       				<div class="panel panel-primary">
               			<div class="panel-heading">Edit FQA</div>
	                		<div class="panel-body">
				<form action="{{URL('admincp/edit-fqa')}}/{{$edit->id}}" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
						...
						<div class="form-group">
							...
							<div class="col-md-10">
								<textarea class="form-control" rows="5" name="answer" >{{$edit->question}}</textarea>
							</div>
						</div>
						<div class="form-group">
