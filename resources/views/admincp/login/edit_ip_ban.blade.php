            ...
            <div class="panel-body">
                <form action="{{URL('admincp/edit-banip')}}/{{$edit_ip->id}}" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    <div class="form-group">
                        <div class="col-md-4"><label class="lable-control">Ip Ban</label></div>
                        <div class="col-md-8">
                            <input class="form-control"  type="text" name="ip_ban"  value="{{$edit_ip->ip_ban}}" 
                                   placeholder="xxx.xxx.xxx.xxx">
                        </div>
                    </div>
                    <div class="form-group">
                    <div class="col-md-4"><label class="lable-control">Status</label></div> 
                        <div class="col-md-8">
