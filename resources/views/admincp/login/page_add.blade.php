            ...
            <div class="panel-body">
                ...
                <form action="{{URL('admincp/add-static-page')}}" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    <div class="form-group">
                        <div class="col-md-2"><label class="lable-control">Title Page</label></div>
                        <div class="col-md-10">
                            <input  type="text" name="titlename" class="form-control" value="" placeholder="Your title page here !">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-2"><label>Content</label></div>
                        <div class="col-md-10">
                            <textarea name="content_page" required rows="15" name="description" class=" form-control wysiwyg"></textarea>
                        </div>
                    </div>
