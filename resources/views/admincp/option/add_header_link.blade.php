			...
			<div class="row ">
				...
				<form action="{{URL('admincp/add-header-link')}}" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
						...
						<div class="form-group">
							...
							<div class="col-md-10"><input type="text" class="form-control" name="content" maxlength="150" rows="5" value="" placeholder=""></div>
						</div>
						...
						<div class="form-group"><!-- to make two field float next to one another, adjust values accordingly -->
							...
							<div class="col-md-10"><input class="form-control"  type="text" name="link" ></div>
						</div>
						<div class="form-group">
