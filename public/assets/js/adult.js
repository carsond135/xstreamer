      ...
      $("#collections").click(function (e) {
            ...
            // $(this).addClass('active');
             $.ajax({
                 ...
                 beforeSend: function () {
                         $('#result-load').html("<img src='"+base_url+"/public/assets/images/result_loading.gif'/>").show();
                     },
                 complete: function ()
                     {
                         $('#result-load').html("<img src='"+base_url+"/public/assets/images/result_loading.gif'/>").hide();
                     }
             });
...
///get channel member subscribe ajax
   $("#channel").click(function (e) {
             ...
             $.ajax({
                 ...
                 beforeSend: function () {
                         $('#subscribe-load').html("<img src='"+base_url+"/public/assets/images/result_loading.gif'/>").show();
                     },
                 complete: function ()
                     {
                         $('#subscribe-load').html("<img src='"+base_url+"/public/assets/images/result_loading.gif'/>").hide();
                     }
             });
             ...
             $.ajax({
                 ...
                 success: function (data) {
                     if(data==0){
                      ...
                      $('#seting').empty().append(data)
                     }


                 },
                 beforeSend: function () {
                         $('#setting-load').html("<img src='"+base_url+"/public/assets/images/result_loading.gif'/>").show();
                     },
                 complete: function ()
                     {
                         $('#setting-load').html("<img src='"+base_url+"/public/assets/images/result_loading.gif'/>").hide();
                     }
             });
          ...
          if(data==0){
            ...
            $('#resultmessage').empty().append(data)
                ...
                beforeSend: function () {
                         ...
                         $('#loadingmessges').html("<img src='"+base_url+"/public/assets/images/result_loading.gif'/> loading Messges").show();
                },
              complete: function (){
                         $('#loadingmessges').html("<img src='"+base_url+"/public/assets/images/result_loading.gif'/> loading Messges").hide();
                }
      })
    });
  $(document).on('click','#friendmember',function(e){
    ...
    $.ajax({
        ...
        success:function(data){
          ...
          $('#loadingmessges').html("<img src='"+base_url+"/public/assets/images/result_loading.gif'/> loading Your Friend").show();
        },complete:function(){
          $('#loadingmessges').html("<img src='"+base_url+"/public/assets/images/result_loading.gif'/> loading Your Friend").hide();
        }
    });
  });
    ...
    $(document).on('click','#send-message-to-member',function (e){
      ...
      $.ajax({
        ...
        success:function(data){
          ...
          $('#member-load-result').html("<img src='"+base_url+"/public/assets/images/result_loading.gif'/>").show();
        },complete:function(){
          $('#member-load-result').html("<img src='"+base_url+"/public/assets/images/result_loading.gif'/>").hide();
        }
      })
  });
...
$(document).on('click','#pornstars-fillter-horizontal li a', function(e){
  ...
  function get_channel_filter(page,key){
     $.ajax({
        url:"filter-channel.html&key="+key+"?page="+page,
        success:function(data){
          console.log(data);
  ...
  function get_porn_star_filter(page,key){
     $.ajax({
        url:"filter-porn-stars.html&key="+key+"?page="+page,
        success:function(data){
          console.log(data);
      ...
      $.ajax({
          ...
          success:function(data){
            if(data==0){
              ...
              $('#loading-upload').html("<img src='"+base_url+"/public/assets/images/result_loading.gif'/>").show();
          },complete:function(){
              $('#loading-upload').html("<img src='"+base_url+"/public/assets/images/result_loading.gif'/>").hide();
          }
      })
  })

  $(document).on('click','#member-upload',function (e){
    $('#loading-upload').html("<img src='"+base_url+"/public/assets/images/result_loading.gif'/>Processing...").show();
  ...
  $(document).on('click','#edit-video',function (e){
    ...
    $.ajax({
      url:"member-delete-video&id="+video_id,
      success:function(data){
        if(data==1){
           $('#loading-upload').html('<div class="alert alert-success"><span  class="glyphicon glyphicon-ok"></span><strong> Video has been delete successfully !</strong></div>').fadeIn().delay(10000).fadeOut();
           $('#result-upload').load(''+base_url+'/show-video-upload.html');
        }if(data==0){
          $('#loading-upload').html('<div class="alert alert-danger"><span  class="glyphicon glyphicon-ok"></span><strong> Video not found !</strong></div>').fadeIn().delay(10000).fadeOut();
        }
        if(data==2){
          $('#loading-upload').html('<div class="alert alert-danger"><span  class="glyphicon glyphicon-ok"></span><strong> Delete video error!. Please try again !</strong></div>').fadeIn().delay(10000).fadeOut();
        }
        if(data==3){
  ...
  $(document).on('click','#edit-thumbnail',function (e){
    ...
    var video_id=$(this).attr('data-id');
    $.ajax({
      url:"member-edit-thumbnail-video&id="+video_id,
      success:function(data){
        ...
        $('#loading-upload').html("<img src='"+base_url+"/public/assets/images/result_loading.gif'/> Please waiting...").show();
      },complete:function(){
        $('#loading-upload').html("<img src='"+base_url+"/public/assets/images/result_loading.gif'/> Please waiting...").hide();
      }
    })
  })
  ...
  $(document).on('click','#resgist-channel',function (e){
      ...
      $.ajax({
        ...
        data:{
          ...
          $('#load-channel').html("<img src='"+base_url+"/public/assets/images/result_loading.gif'/> Please waiting...").show();
        },complete:function(){
          $('#load-channel').html("<img src='"+base_url+"/public/assets/images/result_loading.gif'/> Please waiting...").hide();
        }
        ...
        $.ajax({
             ...
             success: function (data) {
                 ...
                 if(data==0){
                  ...
                  $('#seting-changnel').empty().append(data)
                 }
             ...
             beforeSend: function () {
                     $('#setting-load-channel').html("<img src='"+base_url+"/public/assets/images/result_loading.gif'/>").show();
                 },
             complete: function ()
                 {
                     $('#setting-load-channel').html("<img src='"+base_url+"/public/assets/images/result_loading.gif'/>").hide();
                 }
         });
...
function get_search_page_filter(href,page){
     ...
     $.ajax({
      ...
      if(full_uri!=window.location){
            window.history.pushState({path:full_uri},'',full_uri);
        }
      return false;
  }
//end
  ...
  $(document).on('click','[id*="pornvote-"]',function(event) {
        ...
        $.ajax({
            ...
            if(data['msg']!=''){
                    ...
                    $("#msg-rating").animate({'opacity': 0}, 200, function () {
                    $(this).html('<center class="text-danger">'+data['msg']+'</center>');
                    }).animate({'opacity': 1}, 200);
                    $("#msg-rating").delay(5000).animate({'opacity': 0}, 200, function () {
                ...
                if (data['like'] != 0 || data['dislikes']!= 0) {
                    ...
                    if (data['like'] != $("#pornvote-like-"+item_id+" span").text()) {
                      $("#pornvote-like-"+item_id+" span").animate({'opacity': 0}, 200, function () {
                      $(this).text(data['like']);
                      }).animate({'opacity': 1}, 200);
                    }
                     if (data['dislike'] != $("#pornvote-dislike-"+item_id+" span").text()) {
                      $("#pornvote-dislike-"+item_id+" span").animate({'opacity': 0}, 200, function () {
...
//end pornstar rating
    ...
    $(document).on('click', '#chose-date-video li a', function(e) {
        ...
        var url = "/video.html&action=" + action + "&date=" + data_date + "&time=" + time;
        if (url != window.location) {
    ...
    $(document).on('click', '#sort_by li a', function(e) {
        ...
        var url = "/search.html&keyword=" + keywork + "&sort=" + sort_by + "&date=" + sort_date + "&duration=" + sort_time + "";
        $.ajax({
            url: url,
            success: function(data) {
                $('#ajax-result-content').empty().append(data);
    ...
    $(document).on('click', '#chose-time-cat li a', function(e) {
        ...
        var time = $(this).attr('role');
        var full_text = $(this).attr('full-text');
        window.location.href = '/categories/' + cat + '.' + name + '.html&sort=' + action + '&time=' + time;
    });
    ...
    $(document).on('click','#chose-time li a',function (e) {
        ...
        var url = "/top-rate.html&date=" + data_date + "&time=" + time;
        if(url != window.location){
            window.history.pushState({path:url},'',url);
        }
        $.ajax({
    ...
    $(document).on('click', '#chose-time-view li a', function (e) {
        ...
        var url = "/most-view.html&date=" + data_date + "&time=" + time;
        if(url != window.location) {
            window.history.pushState({path: url}, '', url);
        }
        $.ajax({
    ...
    $('.list-video-filter').click(function() {
        if($('#video-filter').hasClass('hidden')) {
            $('#video-filter').removeClass('hidden');
        } else {
            $('#video-filter').addClass('hidden');
        }
    });

    $('.list-duration-filter').click(function() {
        if($('#chose-time-cat').hasClass('hidden')) {
            $('#chose-time-cat').removeClass('hidden');
        } else {
            $('#chose-time-cat').addClass('hidden');
        }
    });

    $('.list-date-filter').click(function() {
        if($('#chose-date-cat').hasClass('hidden')) {
            $('#chose-date-cat').removeClass('hidden');
        } else {
            $('#chose-date-cat').addClass('hidden');
        }
    });
