    ...
    $.fn.uploadFile = function (options) {
	   ...
	   this.startUpload = function () {
        ...
        function createCutomInputFile(obj, group, s, uploadLabel) {
            ...
            var form = $("<form id='auto-upload' method='" + s.method + "' action='" + s.url + "' enctype='" + s.enctype + "'><input id='_token' type='hidden' nam='_token' value='asdasd' /></form>");
		...
		function defaultProgressBar(obj,s)
		{
            ...
            this.clearfix=$("<div class='clearfix'></div>").appendTo(this.statusbar);
            this.CenterButton=$("<div align='center'></div>").appendTo(this.statusbar);
            this.done = $("<div>" + s.doneStr + "</div>").appendTo(this.CenterButton).hide();
            this.download = $("<div>" + s.downloadStr + "</div>").appendTo(this.CenterButton).hide();
            this.del = $("<div>" + s.deletelStr + "</div>").appendTo(this.CenterButton).hide();
